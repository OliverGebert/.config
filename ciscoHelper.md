ssh switchuser@192.168.178.50


| topic | short key                    | Task                           |
| --- | ------------------------------ | -------------------------- |
| cisco | tab | auto complete |
| cisco | ? | context help |
| cisco | ctrl-a | jump to first char in prompt |
| cisco | ctrl-e | jump to last char in prompt |
| cisco | ctrl-w | deletes last word in current prompt |
| cisco | ctrl-u | deletes all chars in current prompt |
| cisco | ctrl-shift-6 | ends current looping process |
...
| cisco | #show interfaces configuration | info on config of all ports |
...
| cisco | (config)#hostname C1200 | changes the hostname of the switch to C1200 |
